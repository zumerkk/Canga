...
function DatabaseManagement() {
  ...
  const fetchDatabaseStats = async () => {
    try {
      ...
      const response = await axios.get('https://canga-api.onrender.com/api/database/stats');
  ...
  const fetchCollectionData = async (collectionName, filter = {}) => {
    try {
      ...
      const response = await axios.get(
        `https://canga-api.onrender.com/api/database/collection/${collectionName}?${params}`
      );
  ...
  const fetchChartData = async (collectionName, chartType = null, customQuery = {}) => {
    try {
      ...
      const response = await axios.get(
        `https://canga-api.onrender.com/api/database/charts/${collectionName}?${params}`,
  ...
  const fetchRealtimeChartData = async (collectionName) => {
    try {
      const response = await axios.get(`https://canga-api.onrender.com/api/database/charts/${collectionName}/realtime`);
  ...
  const clearCache = async () => {
    try {
      await axios.delete('https://canga-api.onrender.com/api/database/cache');
  ...
  const handleSave = async (formData) => {
    try {
      ...
      if (editMode === 'create') {
        await axios.post(
          `https://canga-api.onrender.com/api/database/collection/${selectedCollection}`,
          formData
        );
        toast.success('Kayıt başarıyla oluşturuldu!');
      } else {
        await axios.put(
          `https://canga-api.onrender.com/api/database/collection/${selectedCollection}/${editingData._id}`,
          formData
        );
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      const deletePromises = [
        axios.delete(`https://canga-api.onrender.com/api/database/collection/${selectedCollection}/${deletingItem._id}`)
      ];
