...
function Shifts() {
  ...
  const fetchShifts = async () => {
    ...
    try {
      ...
      const response = await fetch('https://canga-api.onrender.com/api/shifts?limit=50', {
  ...
  const handleDownloadSignature = async (shift) => {
    try {
      const response = await fetch('https://canga-api.onrender.com/api/excel/export/shift/signature', {
        method: 'POST',
        headers: {
  ...
  const handleDownloadServiceSchedule = async (shift) => {
    try {
      const response = await fetch('https://canga-api.onrender.com/api/excel/export/shift-service-schedule', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const handleDownloadExcel = async (shift) => {
    try {
      const response = await fetch('https://canga-api.onrender.com/api/excel/export/shift', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const handleDeleteShift = async () => {
    try {
      const response = await fetch(`https://canga-api.onrender.com/api/shifts/${selectedShift._id}`, {
        method: 'DELETE'
      });
