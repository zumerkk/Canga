...
async function testSystem() {
  ...
  try {
    const { FACTORY_LOCATION, checkLocationWithinFactory } = require('./utils/locationHelper');
  ...
  const fs = require('fs');
  const files = [
    { path: './services/aiAnomalyAnalyzer.js', name: 'AI Anomaly Analyzer' },
    { path: './routes/locationMap.js', name: 'Location Map Routes' },
    { path: './utils/locationHelper.js', name: 'Location Helper' },
