...
async function main(){
  console.log('🚀 ÇALLIÖZ API updater starting...');
  ...
  fs.writeFileSync(path.join(__dirname, '..', 'calilioz_update_report.json'), JSON.stringify(report, null, 2));
}
